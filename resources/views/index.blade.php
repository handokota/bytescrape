          ...
          <div class="flex flex-row -mx-3">
            ...
            <div class="px-3 text-right basis-1/3">
              <div class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-gray-900 to-slate-800">
                <i class="leading-none fab fa-x-twitter text-lg relative top-3.5 text-white"></i>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="flex flex-row -mx-3">
            ...
            <div class="px-3 text-right basis-1/3">
              <div class="inline-block w-12 h-12 text-center rounded-lg bg-gradient-to-tl from-purple-700 to-pink-500">
                <i class="leading-none fab fa-instagram text-lg relative top-3.5 text-white"></i>
              </div>
            </div>
          </div>
        </div>
