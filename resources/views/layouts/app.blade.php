...
<html>
  <head>
    ...
    <link rel="icon" type="image/png" href="{{url('/')}}/assets/img/logo-twins.png" />
    <title>
    ...
    <!-- Main Styling -->
    <link href="{{url('/')}}/assets/css/soft-ui-dashboard-tailwind.css?v=1.0.20" rel="stylesheet" />    
    <!-- <link href="https://cdn.datatables.net/v/dt/jszip-3.10.1/dt-2.0.8/b-3.0.2/b-colvis-3.0.2/b-html5-3.0.2/b-print-3.0.2/cr-2.0.3/r-3.0.2/rr-1.5.0/sr-1.4.1/datatables.min.css" rel="stylesheet"> -->
    <link href="{{url('/')}}/assets/css/datatables.min.css?v=1.0.1" rel="stylesheet">
    ...
    <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
      <div class="h-19.5">
        ...
        <a class="block px-8 py-6 m-0 text-sm whitespace-nowrap text-slate-700" href="{{ url('/') }}">
            <img src="{{ url('/') }}/assets/img/logo-transparent.png" class="inline h-full max-w-full transition-all duration-200 ease-nav-brand max-h-8" alt="main_logo" />
      ...
      <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
          ...
          <li class="mt-0.5 w-full">
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors" href="{{url('/')}}/pages/profile.html">
          ...
          <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto">
            ...
            <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
              {{-- <li class="flex items-center">
                <a href="{{url('/')}}/pages/sign-in.html" class="block px-0 py-2 text-sm font-semibold transition-all ease-nav-brand text-slate-500">
              ...
              <li class="flex items-center hidden px-4">
  ...
  <!-- main script file  -->
  <script src="{{url('/')}}/assets/js/soft-ui-dashboard-tailwind.js?v=1.0.20" async></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.7.1/jquery.min.js" integrity="sha512-v2CJ7UaYy4JwqLDIrZUI/4hqeoQieOmAZNXBeQyjo21dadnwR+8ZaIJVT8EE2iyI61OV8e6M8PP2/4hpQINQ/g==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
 
  <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/pdfmake.min.js"></script>
  <script src="https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.7/vfs_fonts.js"></script>
  <!-- <script src="https://cdn.datatables.net/v/dt/jszip-3.10.1/dt-2.0.8/b-3.0.2/b-colvis-3.0.2/b-html5-3.0.2/b-print-3.0.2/cr-2.0.3/r-3.0.2/rr-1.5.0/sr-1.4.1/datatables.min.js"></script> -->
  <script src="{{url('/')}}/assets/js/datatables.min.js?v=1.0.1"></script>
